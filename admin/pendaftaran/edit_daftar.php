            ...
            <div class="card-body">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="id_daftar" class="form-control" value="<?php echo $data['id_daftar']; ?>" readonly="true" />
                    </div>
                    <div class="form-group">
                        <label><b>Tanggal Daftar</b> </label>
                        <input type="date" name="tgl_daftar" class="form-control" value="<?php echo $data['tgl_daftar']; ?>" required />
                    </div>
                    <div class="form-group">
